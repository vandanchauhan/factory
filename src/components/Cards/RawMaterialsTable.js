...
import {rawMaterialData} from "../../assets/data";
import {Link} from "react-router-dom";

export default function RawMaterialsTable({ color }) {
  return (
    <>
      <div
        className={
            ...
            {rawMaterialData.map((rawMaterial, index) => {
              return <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                  ...
                  {rawMaterial.qty} {rawMaterial.units}
                </td>
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                  ...
                  {/*  ></img>*/}
                  {/*</div>*/}
                  {rawMaterial.qty > rawMaterial.required ?
                      <i className="fas fa-circle text-orange-500 mr-2"></i> :
                      <i className="fas fa-circle text-emerald-500 text-center mr-2"></i>}
                  {rawMaterial.qty > rawMaterial.required ? 'Yes, restock fast!' : 'Not yet, were good!'}
                </td>
...
RawMaterialsTable.defaultProps = {
  color: "light",
};

RawMaterialsTable.propTypes = {
